...
const ModalNeighborhood: React.FC<ModalProps> = ({
  isOpen,
  onClose,
  isDismissable = true,
}) => {
  ...
  const handleSave = async () => {
    if (!inputValue) {
      alert("Por favor, insira o nome do bairro.");
      return;
    }

    await AppService.storeNeighborhood(inputValue);
      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            <Text style={styles.modalTitle}>Inserir um novo Bairro</Text>
            <TextInput
